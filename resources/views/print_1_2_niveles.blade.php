<html>
    ...
    <body>
        <div class="container">
            Fecha de Generación: {{$fecha}}  - Paqui Express
            <div class="row" style="border-top: 1px solid">
                <table style="width: 100%">
                    <tr>
                        <td style="width: 15%;">
                            <img width="160" height="100" src="{{asset('images/logo.png')}}" />
                        </td>
                        <td style="width: 85%; text-align: center;">
                            <b style="font-size:20px;">{{$titulo}}</b>
                        </td>
                    </tr>
                </table>
            </div>
                    ...
                    <div class="row">
                        <table style="width: 100%;">
                            ...
                            foreach ($encabezado as $key => $value) {
                                $i = $i + 1;
                                $van = $van + 1;
                                $row1 = $row1 . "<th style='width: 33.3% !important; background-color: #d2152c; color:#FFFFFF; font-size:14px;'>" . $key . "</th>";
                                $row2 = $row2 . "<th style='width: 33.3%; text-align: center; background-color:#9ec437; color:#FFFFFF; font-size:14px;'>" . $value . "</th>";
                                if ($i === 3) {
                                    $i = 0;
                    ...
                    <div class="row">
                        ...
                        if ($nivel === 1) {
                            ...
                            foreach ($cabeceras as $c) {
                                $i = $i + 1;
                                $van = $van + 1;
                                $html = $html . "<th style='width: 20% !important; background-color:#d2152c; color:#FFFFFF; font-size:13px;'>" . $c . "</th>";
                                if ($i === 5) {
                                    $i = 0;
                                    $html = $html . "</tr><tr>";
                                } else {
                            ...
                            foreach ($data as $value) {
                                ...
                                foreach ($value as $t) {
                                    $i2 = $i2 + 1;
                                    $van2 = $van2 + 1;
                                    $html = $html . "<td style='font-size:12px;'>" . $t . "</td>";
                                    if ($i2 === 5) {
                                        $i2 = 0;
                                        if ($parastilo % 2 == 0) {
